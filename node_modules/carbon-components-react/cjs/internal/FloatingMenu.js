...
var FloatingMenu = function (_React$Component) {
  ...
  function FloatingMenu() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FloatingMenu.__proto__ || Object.getPrototypeOf(FloatingMenu)).call.apply(_ref, [this].concat(args))), _this), _this.getMenuPosition = function () {
      ...
      var childrenWithProps = _react2.default.cloneElement(_this.props.children, {
        style: style
      });

      _reactDom2.default.render(childrenWithProps, _this.menu);
  ...
  _createClass(FloatingMenu, [{
    ...
    value: function componentDidMount() {
      if (this.doc) {
        ...
        _reactDom2.default.render(childrenWithProps, this.menu);
...
FloatingMenu.propTypes = {
  ...
  menuPosition: _propTypes2.default.object.isRequired,
  menuDirection: _propTypes2.default.oneOf(['left', 'top', 'right', 'bottom']).isRequired,
  menuOffset: _propTypes2.default.object.isRequired,
