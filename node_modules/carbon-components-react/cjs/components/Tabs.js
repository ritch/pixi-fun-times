...
var Tabs = function (_React$Component) {
  ...
  function Tabs() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      selectedLabel: _react2.default.Children.toArray(_this.props.children)[0].props.label
      ...
      var tabCount = _react2.default.Children.count(_this.props.children) - 1;
  ...
  _createClass(Tabs, [{
    ...
    value: function getTabs() {
      return _react2.default.Children.map(this.props.children, function (tab) {
        return tab;
      });
    }
    ...
    value: function render() {
      ...
      var tabsWithProps = this.getTabs().map(function (tab, index) {
        var newTab = _react2.default.cloneElement(tab, {
          index: index,
      ...
      var tabContentWithProps = _react2.default.Children.map(tabsWithProps, function (tab) {
      ...
      var classes = {
        tabs: (0, _classnames2.default)('bx--tabs', className),
        tablist: (0, _classnames2.default)('bx--tabs__nav', {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_Icon2.default, { description: iconDescription, name: 'caret--down' })
          ),
          _react2.default.createElement(
            'ul',
...
Tabs.propTypes = {
  ...
  firstSelectedLabel: _propTypes2.default.string,
  hidden: _propTypes2.default.bool,
  href: _propTypes2.default.string.isRequired,
  role: _propTypes2.default.string.isRequired,
  onClick: _propTypes2.default.func,
  onKeyDown: _propTypes2.default.func,
  triggerHref: _propTypes2.default.string.isRequired,
